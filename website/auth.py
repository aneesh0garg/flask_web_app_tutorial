    ...
    if request.method == 'POST':
        ...
        if user:
            if check_password_hash(user.password, password):
                ...
                login_user(user, remember=True) ##remembers unti borwser cach
...
def signup():
    # Here you would typically handle the signup logic (e.g., save user to database)
    if request.method == 'POST':
        data = request.form
        email = request.form.get('email')
